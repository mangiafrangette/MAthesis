...
def parse_and_write(file_path):
    ...
    path_to_find = {
        ...
        "article_title": './/tei:titleStmt/tei:title', "authors": './/tei:titleStmt/tei:author', "given": './/tei:forename', "family": './/tei:surname', "affiliation": './/tei:affiliation', "publisher": './/tei:publicationStmt/tei:publisher', "date": './/tei:publicationStmt/tei:date', "keywords": './/tei:keywords', "journal_title": None, "volume": None, "issue": None, "ISSN": [ { "value": None, "type": None } ] 
    }
    ...
    for key, value in path_to_find.items():
        if type(value) is str:
            ...
            # other things 
            elif key != "given" and key != "family" and key != "affiliation" and key != "keywords":    
                for element in root.find(value, ns).itertext():
...
def write_new_json():
    ...
    path = '../data/adho_conferences/2010'
    ...
    with open(f"../data/adho_conferences/ms_ADHO_2010.json", "w", encoding="utf-8") as fd:
        fd.write("[")
