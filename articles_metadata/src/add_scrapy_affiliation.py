...
add_scraped_affiliations("../data/json_files/my_schema/ms_CF_Digital_Studies__Le_champ_numérique copy.json", "../data/json_files/scraped_affiliations/CF_aff_le_champ.json")
