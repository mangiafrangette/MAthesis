...
def parse_and_write(file_path):
    ...
    path_to_find = {
        ...
        "abstract": './/tei:notesStmt/tei:note[@type="abstract"]', 
        "article_title": './/tei:titleStmt/tei:title', 
        "authors": './/tei:titleStmt/tei:author', 
        "given": './/tei:forename', "family": './/tei:surname', "affiliation": './/tei:affiliation', 
        "publisher": './/tei:publicationStmt/tei:publisher', 
        "date": './/tei:editionStmt/tei:edition/tei:date', 
        "keywords": './/tei:keywords[@n="topics"]', 
...
def write_new_json():
    ...
    path = '../data/adho_conferences/2018'
    ...
    with open(f"../data/adho_conferences/ms_ADHO_2018.json", "w", encoding="utf-8") as fd:
        fd.write("[")
