...
def datacite_to_my_schema(path, file_name):
    with open(f'{path}/{file_name}', "r", encoding="utf-8") as f:
        ...
        with open(f"../data/json_files/datacite_my_schema/{file_name}", "a", encoding="utf-8") as fd:
            fd.write("[")
...
for file in os.listdir(folder):
    ...
    if filename.endswith('datacite_metadata.json'): # whatever file types you're using...
